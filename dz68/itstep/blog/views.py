...
from blog.models import Post, Category, Tag, Rating
from django.db.models import Avg, Q
from . import forms
from .forms import PostForm, RatingForm, TagFormModel
...
#     current_rating = post.ratings.aggregate(Avg('rating'))['rating__avg'] or 0
#     current_rating = int(round(current_rating))
    
#     return render(request, 'blog/post/fssfsf.html', {'post': post, 'current_rating': current_rating, 'form': RatingForm()})
